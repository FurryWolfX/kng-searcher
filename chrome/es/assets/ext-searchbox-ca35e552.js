import{n as R}from"./index-a0976c3f.js";function I(u,x){for(var a=0;a<x.length;a++){const h=x[a];if(typeof h!="string"&&!Array.isArray(h)){for(const p in h)if(p!=="default"&&!(p in u)){const i=Object.getOwnPropertyDescriptor(h,p);i&&Object.defineProperty(u,p,i.get?i:{enumerable:!0,get:()=>h[p]})}}}return Object.freeze(Object.defineProperty(u,Symbol.toStringTag,{value:"Module"}))}var k={exports:{}};(function(u,x){ace.define("ace/ext/searchbox-css",["require","exports","module"],function(a,h,p){p.exports=`
...
//# sourceMappingURL=ext-searchbox-ca35e552.js.map
